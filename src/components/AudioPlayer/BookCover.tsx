...
const BookCover: React.FC<BookCoverProps> = ({ fileName, isPlaying, coverUrl, title }) => {
  return (
    <div className={`relative w-full sm:w-64 h-64 rounded-xl shadow-lg flex items-center justify-center overflow-hidden ${isPlaying ? 'animate-pulse-light' : ''}`}>
      {coverUrl ? (
        <>
          <img 
            src={coverUrl} 
